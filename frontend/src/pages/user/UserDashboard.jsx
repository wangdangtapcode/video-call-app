...
export const UserDashboard = () => {
    const { user, logout, isLoading, isInitialized, isAuthenticated,token } = useUser();
    ...
    const { loadOnlineAgents, onlineAgents, isLoadingAgents, isConnected } = useAgentPresence();
    ...
    }, [showAgentsList, isConnected, loadOnlineAgents]);
    ...
    const confirmAgentSelection = async () => {
        ...
        try {
            const response = await fetch('http://localhost:8081/api/support/requests', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                alert(`✅ Đã gửi yêu cầu hỗ trợ đến ${getAgentDisplayName(agentToConfirm)}! Vui lòng chờ agent xác nhận.`);
                    ...
                    <div id="agents-list" className="mb-8">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                >
                                    <svg 
                                        className={`w-5 h-5 ${isLoadingAgents ? 'animate-spin' : ''}`} 
                                        fill="none" 
                                        stroke="currentColor" 
                                        viewBox="0 0 24 24"
                                    >
                                            ...
                                            <div className="bg-white border border-gray-200 rounded-xl shadow-xl p-4 min-w-64">
                                                ...
                                                <div className="space-y-2 text-xs">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <span className="text-gray-900 font-medium">{agent.email || 'N/A'}</span>
                                                    </div>
                                                    <div className="flex items-center justify-between">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 transform transition-all duration-300 scale-100">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="space-y-2 text-sm">
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <span className="text-gray-700">{agentToConfirm.email}</span>
                                            </div>
                                            <div className="flex items-center justify-center gap-2">
                                                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                                                <span className="text-green-600 font-medium">Online - Sẵn sàng hỗ trợ</span>
                                            </div>
                                            <div className="flex items-center justify-center gap-2">
                                                <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="px-6 pb-4">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-500 text-sm">
                                        Agent sẽ nhận được thông báo và có thể bắt đầu hỗ trợ bạn ngay lập tức
                                    </p>
                                </div>
                            </div>
